...
import { apiTestingPlanDocument } from "../content/documents/api-testing-plan";
    ...
    <>
      <Stack spacing={3} data-testid="documentation-section-api-testing-plan">
        ...
        <Stack spacing={1}>
          ...
          <Typography variant="body2" color="text.secondary">
            The goal is to ensure that REST endpoints provide correct responses, handle invalid
            input properly and support frontend functionality in a predictable manner.
          </Typography>
        </Stack>
        ...
        <SourceDocumentCard
          ...
          subtitle={apiTestingPlanDocument.title}
          ...
          testId="api-testing-source-documentation"
        />
        ...
        <Button
          ...
          data-testid="api-testing-view-full-document"
        >
          View Full Document
        </Button>
      </Stack>
      ...
      <DocumentViewerDialog
        document={apiTestingPlanDocument}
        open={isDocumentOpen}
        testId="api-testing-document-viewer-dialog"
