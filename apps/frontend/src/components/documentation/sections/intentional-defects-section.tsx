  ...
  return (
    <Stack spacing={3} data-testid="documentation-section-intentional-defects">
      ...
      <SourceDocumentCard
        ...
        subtitle="Intentional Defects Plan (Full Document)"
        description="The complete intentional defects strategy is available as a dedicated project document and will be linked here after document integration is completed."
      />
    </Stack>
  );
}
