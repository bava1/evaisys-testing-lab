  ...
  return (
    <Stack spacing={3} data-testid="documentation-section-playwright-automation-plan">
      ...
      <SourceDocumentCard
        ...
        subtitle="Playwright Automation Plan (Full Document)"
        description="The complete automation plan is available as a dedicated project document and will be linked here after document integration is completed."
      />
    </Stack>
  );
}
